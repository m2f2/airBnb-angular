...
import { Category, CategoryName } from './category.modules';
...
export class CategoryService {
  // Define an array of categories with predefined attributes
  ...
  // BehaviorSubject to track the currently selected category and provide an observable stream
  ...
  /**
   * Updates the current selected category and emits the new value to subscribers.
...
/**
   * Returns the default category (the first one in the list).
   * @returns The default Category object.
   */
  getCategoryByDefault() {
    return this.categories[0];
  }
/**
   * Finds and returns a category by its technical name.
   * @param technicalName The technical name of the category to be found.
